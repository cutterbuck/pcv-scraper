...
def manage_scheduler(sched):
    ...
    start_time = datetime(today.year, today.month, today.day, 20, 20, 0).astimezone(ZoneInfo('UTC'))
...
def run_scheduler():
    ...
    manage_jobs_trigger = CronTrigger(year="*", month="*", day="*", hour="20", minute="15", second="0")
